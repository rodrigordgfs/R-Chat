  ...
  return (
    <main className="bg-zinc-900 w-screen h-screen flex justify-center">
      <div className="mx-0 my-auto flex flex-col items-center">
        ...
        <button className="bg-zinc-600 hover:bg-zinc-700 transition-colors h-10 w-full rounded-full font-semibold text-white mt-4 flex flex-row items-center justify-center gap-4 px-10">
